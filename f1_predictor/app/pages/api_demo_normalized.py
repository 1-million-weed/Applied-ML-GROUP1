...
class ApiDemoPageNormalized(Page):
    def __init__(self, training_features: list = []):
        super().__init__("API Demo Normalized")
        self.training_features = training_features

    def display(self):
        st.title("API Demo Normalized")
    ...
    def call_api(self, feature_values):
        ...
        # Example:
        response = httpx.post("http://localhost:8000/predict_normalized", json=feature_values)
